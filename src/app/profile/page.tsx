    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-[900px] mx-auto px-4 pb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
          {[
            { label: "Mi Portafolio", href: "/portafolio", icon: TrendingUp, color: "text-blue-500", bg: "bg-blue-500/10" },
            { label: "Suscripción", href: "/suscripcion", icon: Newspaper, color: "text-purple-500", bg: "bg-purple-500/10" },
            { label: "Mi Organización", href: "/empresas/dashboard", icon: Building2, color: "text-emerald-500", bg: "bg-emerald-500/10" },
          ].map((action) => (
        ...
        <div className="grid grid-cols-2 gap-3 mb-8">
          {[
            ...
            { label: "Mercados", value: "En vivo", icon: BarChart3, color: "text-emerald-500" },
          ].map((stat) => (
            <div
              key={stat.label}
