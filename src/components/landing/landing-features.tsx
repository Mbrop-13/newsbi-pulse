...
const SECTIONS = [
  {
    id: "ai-assistant",
    title: "Asistente Conversacional R-AI",
    desc: "Pregúntale sobre cualquier evento económico, tendencia o noticia. R-AI investiga fuentes en vivo, resume el contexto y responde de forma crítica y analítica. Ahora, analizar mercados es tan fácil como mantener una conversación.",
    cta: "Más sobre el Asistente",
    link: "/ai",
    visual: (
      <div className="relative w-full h-full min-h-[300px] md:min-h-[380px] bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center p-8 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-sm rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 p-6 text-white text-xs font-mono shadow-xl">
          <div className="flex items-center justify-between mb-3 border-b border-white/10 pb-2">
            <span className="flex items-center gap-1.5"><Bot className="w-4 h-4 text-cyan-300" /> R-AI Consenso</span>
          ...
          <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
            <div className="w-3/4 h-full bg-[#38BDF8]" />
          </div>
        </div>
        ...
        <div className="absolute inset-0 bg-black/35 flex flex-col items-center justify-center cursor-pointer hover:bg-black/25 transition-all">
          <div className="w-14 h-14 rounded-full bg-white text-blue-600 flex items-center justify-center shadow-lg hover:scale-110 transition-transform">
            <Play className="w-6 h-6 fill-blue-600 translate-x-0.5" />
          </div>
  ...
  },
  {
    ...
    desc: "Monitorea tus activos financieros en tiempo real y recibe reportes agregados automáticos. R-AI audita las noticias del mercado internacional y te avisa de inmediato de cualquier cambio que afecte tus inversiones.",
  ...
  },
  {
    ...
    link: "/noticias",
    visual: (
      <div className="relative w-full h-full min-h-[300px] md:min-h-[380px] bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center p-8 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-sm rounded-2xl bg-white p-5 text-slate-900 shadow-xl border border-slate-100">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full border-4 border-emerald-500/20 border-t-emerald-500 flex items-center justify-center font-mono text-xs font-black text-slate-800">
              9.2
            </div>
            <div>
              <p className="text-[10px] font-bold text-emerald-600">Confianza muy alta</p>
        ...
        {/* Video Overlay Placeholder */}
        <div className="absolute inset-0 bg-black/35 flex flex-col items-center justify-center cursor-pointer hover:bg-black/25 transition-all">
          <div className="w-14 h-14 rounded-full bg-white text-cyan-600 flex items-center justify-center shadow-lg hover:scale-110 transition-transform">
            <Play className="w-6 h-6 fill-cyan-600 translate-x-0.5" />
          </div>
          <span className="text-white text-xs font-bold mt-3 uppercase tracking-wider">Ver Vídeo Demo</span>
        </div>
      </div>
  ...
  return (
    <section className="bg-white text-slate-900 overflow-hidden select-none font-sans">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-24 pb-12">
        <h2 className="text-sm font-bold tracking-widest text-[#1890FF] uppercase mb-4">
          ...
          >
            <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              >
                ...
                <Link 
                  href={section.link}
                  className="inline-flex items-center gap-1 text-[#1890FF] text-xs md:text-sm font-bold hover:underline"
                >
