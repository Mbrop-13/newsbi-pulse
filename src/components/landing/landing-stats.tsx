  ...
  return (
    <section className="pt-2 pb-8 bg-white select-none font-sans">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="bg-black border border-slate-800/80 rounded-3xl p-8 md:p-16 relative overflow-hidden">
          ...
          <div className="w-full aspect-[16/7] md:aspect-[21/8] relative mb-4 rounded-2xl overflow-hidden bg-black">
            <img 
            ...
            />
            {/* Edge fade overlays — gradients matching black to dissolve the image edges */}
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_transparent_25%,_black_80%)] pointer-events-none" />
            <div className="absolute inset-x-0 top-0 h-16 bg-gradient-to-b from-black via-black/40 to-transparent pointer-events-none" />
            ...
            <div className="absolute inset-y-0 left-0 w-20 bg-gradient-to-r from-black via-black/40 to-transparent pointer-events-none" />
            <div className="absolute inset-y-0 right-0 w-20 bg-gradient-to-l from-black via-black/40 to-transparent pointer-events-none" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 relative z-10">
            ...
            <div>
              <div className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400 mb-2">
                10 M o más
              </div>
