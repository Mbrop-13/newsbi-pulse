...
const VARIANTS: Record<BannerVariant, {
  ...
  upgrade: {
    ...
    subtitle: "Accede a más capacidad de preguntas, audios y alertas.",
    cta: "Ver planes",
    href: "/suscripcion",
  ...
  trial: {
    ...
    title: "Descubre las funciones del Plan Pro",
    subtitle: "Acceso a IA avanzada, alertas y análisis financiero.",
    cta: "Ver plan Pro",
    href: "/suscripcion",
